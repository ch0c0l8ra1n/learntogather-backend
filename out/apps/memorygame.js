...
var MemoryGame = /** @class */ (function (_super) {
    __extends(MemoryGame, _super);
    function MemoryGame(gameRoom) {
        var _this = _super.call(this, MemoryGame.NAME) || this;
    ...
    MemoryGame.prototype.seen = function (controller) {
    ...
    MemoryGame.prototype.unseen = function (controller) {
        if (this.seenWords.includes(this.word)) {
            this.appStage = "lost";
        }
        else {
    ...
    MemoryGame.prototype.service = function () {
    ...
    MemoryGame.prototype.handleEvent = function (event, data, controller) {
        switch (event) {
            case "seen":
    ...
    MemoryGame.prototype.getAppState = function () {
        return {
            word: this.word,
